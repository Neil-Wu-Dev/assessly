...
public class RuleServiceImpl implements RuleService {
    ...
    public RuleSet generate(UUID ownerId, UUID datasetId) {
        ...
        String rulesJson = JsonSupport.write(Map.of("rules", List.of(Map.of(
                ...
                "explanation", "Demo constrained AST generated by the PoC boundary. Replace with selected AI provider generated JSON after validation.",
                "ast", Map.of(
                        "type", "if",
        ...
        try {
            ruleEngine.validateRuleSet(rulesJson);
            RuleSet ruleSet = new RuleSet(datasetId, ruleSets.nextVersion(datasetId), RuleGenerationStatus.READY, rulesJson, JsonSupport.write(Map.of("status", "READY", "note", "AI provider integration boundary validated; current PoC emits a constrained demo rule.")));
            return ruleSets.save(ruleSet);
