...
public class BenchmarkResult {
    ...
    public BenchmarkResult(boolean structurallyEquivalent, boolean executionEquivalent, String generatedExecutionJson, String groundTruthExecutionJson, List<Map<String, Object>> differences) {
    ...
    public boolean isStructurallyEquivalent() {
        return structurallyEquivalent;
    }

    public boolean isExecutionEquivalent() {
        return executionEquivalent;
    }
    ...
    public String getGeneratedExecutionJson() {
        return generatedExecutionJson;
    }

    public String getGroundTruthExecutionJson() {
        return groundTruthExecutionJson;
    }
